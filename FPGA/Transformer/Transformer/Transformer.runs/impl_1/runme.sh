...
HD_PWD='C:/Users/Ahmed/Desktop/MedEdge-Transformer/FPGA/Transformer/Transformer/Transformer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dot_product.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dot_product.tcl -notrace
