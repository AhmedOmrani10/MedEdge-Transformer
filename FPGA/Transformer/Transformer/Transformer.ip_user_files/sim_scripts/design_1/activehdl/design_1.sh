...
#
# Script generated by Vivado on Wed Mar 11 15:58:33 +0100 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Ahmed/Desktop/MedEdge-Transformer/FPGA/Transformer/Transformer/Transformer.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
